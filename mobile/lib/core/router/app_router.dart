...
// Engagement: collectibles and the decodable story shelf.
...
class AppRouter {
  ...
  List<RouteBase> get _routes => [
        ...
        ShellRoute(
          ...
          //
          // Progress and Spelling Bee are full-screen routes below rather
          // than tabs. Spelling Bee runs its game inside its own screen, so
          // as a tab it would keep the nav bar up throughout and a child
          // halfway through spelling a word could tap Home and lose it. A
          // screen that is a task should offer no way out but finishing.
          routes: [
